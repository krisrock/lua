...
-- dependencies
--
local database_load = require "Chinesehelper"
...
surfacefont_size_cus = ui.new_slider("LUA", "A", "Font Size", 17, 50, 0, true, "x")
surfacefont_zhus_cus = ui.new_slider("LUA", "A", "ZhuShi Font Size", 17, 50, 0, true, "x")
					...
					if location.viewangles_target ~= nil then
						...
						if wx ~= nil then
							...
							if description ~= nil then
								surface.draw_text(wx_topleft+target_size, wy+title_height, math.min(255, r_m*1.2), math.min(255, g_m*1.2), math.min(255, b_m*1.2), a_m*visible_alpha*0.92, despite_font, description)
							end
