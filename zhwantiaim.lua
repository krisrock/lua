local a=(function()local a={callback_registered=false,maximum_count=7,data={},svg_texture=[[]]}local b={w=10,h=30}local c=renderer.load_svg(a.svg_texture,b.w,b.h)function a:register_callback()if self.callback_registered then return end;client.set_event_callback('paint_ui',function()local d={client.screen_size()}local e={30,30,30}local f=5;local g=self.data;for h=#g,1,-1 do g[h].time=g[h].time-globals.frametime()local i,j=255,0;local k=g[h]if k.time<0 then table.remove(g,h)else local l=k.def_time-k.time;local l=l>1 and 1 or l;if k.time<0.5 or l<0.5 then j=(l<1 and l or k.time)/0.5;i=j*255;if j<0.2 then f=f+15*(1.0-j/0.2)end end;local m={renderer.measure_text("dc",k.draw)}local n={d[1]/2-m[1]/2-7,d[2]-d[2]/200*12.4+f}renderer.rectangle(n[1]-2500,n[2]-1500,m[1]+5000,5008,e[1],e[2],e[3],i<=200 and i or 200)renderer.line(n[1]-30,n[2]-450,n[1]-30,n[2]-20+72,155,0,i<=50 and i or 50)renderer.texture(c,n[1]-b.w/2-5,n[2]-b.h/2-535,b.w,b.h,72,155,194,i)f=f-50 end end;self.callback_registered=true end)end;function a:paint(o,p)local q=tonumber(o)+1;for h=self.maximum_count,2,-1 do self.data[h]=self.data[h-1]end;self.data[1]={time=q,def_time=q,draw=p}self:register_callback()end;return a end)()a:paint(1,'TEMPEST')local r=(function()local s={callback_registered=false,maximum_count=7,data={}}function s:register_callback()if self.callback_registered then return end;client.set_event_callback("paint_ui",function()local t={client.screen_size()}local u={1,1,1}local f=5;local v=self.data;for h=#v,1,-1 do self.data[h].time=self.data[h].time-globals.frametime()local w,j=255,0;local x=v[h]if x.time<0 then table.remove(self.data,h)else local y=x.def_time-x.time;local y=y>1 and 1 or y;if x.time<0.5 or y<0.5 then j=(y<1 and y or x.time)/0.5;w=j*255;if j<0.2 then f=f+15*(1.0-j/0.2)end end;local z={renderer.measure_text(nil,x.draw)}local A={t[1]/2-z[1]/2+3,t[2]/2}renderer.circle(A[1],A[2],u[1],u[2],u[3],w,25,180,0.5)renderer.circle(A[1]+z[1],A[2],u[1],u[2],u[3],w,25,0,0.5)renderer.rectangle(A[1],A[2]-25,z[1],50,u[1],u[2],u[3],w)renderer.text(A[1]+z[1]/2,A[2],255,255,255,w,"c",nil,x.draw)f=f-50 end end;self.callback_registered=true end)end;function s:paint(B,C)local D=tonumber(B)+1;for h=self.maximum_count,2,-1 do self.data[h]=self.data[h-1]end;self.data[1]={time=D,def_time=D,draw=C}self:register_callback()end;return s end)()r:paint(1,"TEMPEST")local E=(function()local s={callback_registered=false,maximum_count=7,data={}}function s:register_callback()if self.callback_registered then return end;client.set_event_callback("paint_ui",function()local t={client.screen_size()}local u={50,50,50}local f=5;local v=self.data;for h=#v,1,-1 do self.data[h].time=self.data[h].time-globals.frametime()local w,j=255,0;local x=v[h]if x.time<0 then table.remove(self.data,h)else local y=x.def_time-x.time;local y=y>1 and 1 or y;if x.